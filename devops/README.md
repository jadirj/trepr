...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trepr-jadirj.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for trepr-jadirj.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/trepr-jadirj.tangrama.com.br.yml` to the remote server with:
